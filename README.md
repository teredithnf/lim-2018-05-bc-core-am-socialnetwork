...
En la actualidad las mas exitosas redes sociales cuentan con elementos principales que permiten y aseguran el exito de ellas, a continuación mencionaremos los elementos básicos que encontramos en nuestro benchmarking :

- Nombre distintivo de la red social
- Logo
...
Nuestro fin es proporcionar al usuario un medio objetivo donde puedan interactuar con todas aquellas personas que tengan ideas afines ,permitiendoles mediante nuestra implementación llegar a miles de usuarios a nivel mundial y que sea este un canal de expansión de sus ideales.

## Objetivos de los usuarios en relacion con el producto

Los objetivos de la mayoria de los usuarios es transmitir  de forma masiva y a gran escala sus ideas proteccionistas y que estas generen un cambio ;tambien uno de los objetivos es poder encontrar inversores con los mismos ideales.

## Principales funcionalidades de Ambientalist Lovers

Funcionalidades de Ambientalist Lovers

- Muro que pueden visualizar usuarios registrados y usuarios no registrados.

- Posibilita el intercambio de conocimiento, para ello hemos creado el post para compartir sus ideas.

- Creacion de comunidad, para ello cualquier pesona interesada se puede registrar y participar de Ambientalist Lover.

- Al poner una publicación   se puede editar en el caso que hayamos cometido un error tipográfico, o no sea el mensaje que debimos publicar, asimismo permite la eliminación de mensajes.

- Se implemento la opción de darle me gusta , para poder hacer conocer a los demas usuarios que tuvieron una idea interesante o con relevancia.

- Publicaciones con la especificación de publico para que lo que posteastes sea conocido por toda la comunidad y opcion de poder publicar como privado para guardar informacion que sea relevante para el usuario y que no sea visualizada para los demas usuarios.
...
Concluimos que el prototipado de alta fidelidad era agradable para los usuarios, recibimos feedback sobre los colores que iban vien con el tema de la pagina, y sobre las imagenes que eran agradables y consecuentes con el tema ;asi mismo recibimos la aprobacion sobre el diseño del muro y la zona de posteo.
...
[Formulario vista Inicial](http://subirimagen.me/uploads/20180806091209.jpg)
